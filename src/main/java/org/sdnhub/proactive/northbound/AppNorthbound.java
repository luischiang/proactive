...
package org.sdnhub.proactive.northbound;
...
import org.sdnhub.proactive.Proactive;
import org.sdnhub.proactive.IProactive;
...
public class AppNorthbound {
    ...
    public String getEcho(@PathParam("echo") String echo) {
    	...
    	IProactive proactive = (IProactive) ServiceHelper.getInstance(IProactive.class, "default", this);
